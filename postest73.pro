...
clauses
  ...
  length_of([_|T],Result,Counter):-
	NewCounter = Counter + 1,/*increment pada newcounter*/
	length_of(T, Result, NewCounter)./*dan length_of itu menjadi (tail yang ada dan result, new counter itu sama seperti L */
